...
function bootstrap_theme(&$existing, $type, $theme, $path) {
  ...
  return array(
     /*Custom NS*/
    'programme_n1_node_form' => array(
      'arguments' => array(
      'form' => NULL,
      ),
      'template' => 'templates/page/programme_n1-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'programme_saisons_node_form' => array(
      'arguments' => array(
      'form' => NULL,
      ),
      'template' => 'templates/page/programme_saisons-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
     'programme_obs_libre_node_form' => array(
      'arguments' => array(
      'form' => NULL,
      ),
      'template' => 'templates/page/programme_obs_libre-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
     'programme_new_node_form' => array(
      'arguments' => array(
      'form' => NULL,
      ),
      'template' => 'templates/page/programme_new-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
     'programme_flore_node_form' => array(
      'arguments' => array(
      'form' => NULL,
      ),
      'template' => 'templates/page/programme_flore-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
     'programme_dechet_node_form' => array(
      'arguments' => array(
      'form' => NULL,
      ),
      'template' => 'templates/page/programme_dechet-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ), /*FIN Custom NS*/
...
function bootstrap_preprocess_page(&$variables) {
  ...
  */
  ...
  if (isset($node->nid) && $node->type == 'programme_obs_libre') {
    //essayer de changer le nom du node a la volée:
