...
<div id='breadcrumPersoN9'>
	<a href="<?php echo $base_url; ?>" alt=''>Accueil</a> > <a href="<?php echo $base_url; ?>/liste-actions" alt=''>Actions</a> > <a href="<?php echo $base_url; ?>/Chlorophylle-mania" alt=''>Chlorophylle-mania</a> > Saisie des données
</div>


<div class='container contentOfEditFormN9'>

	<div class='row-fluid' id='fold1InEditFormN9'>
		<div class='span12'>			
			<?php print drupal_render($form['field_date_observation_flore']); ?>
			<?php print drupal_render($form['field_heure_debut_flore']); ?>
			<?php print drupal_render($form['field_heure_fin_flore']); ?>
		</div>
	</div>
	...
	<div class='row-fluid'>
		...
		<div class='span4' id='leftColOnFold2OfEditFormN9'>
			<div class='row-fluid'>			
			<div class='span12'>
			<legend id='fieldPointRepere'><span class="fieldset-legend">Site d'observation</span></legend>
			<?php print drupal_render($form['field_zone_observation_flore']); ?>
			</div>
			</div>

			<div class='row-fluid'>	
			<div class='span12'>
			<?php print drupal_render($form['field_point_de_repere_flore']); ?>
			</div>
			</div>
		...
		<div class='span8'>
			<?php print drupal_render($form['field_localisations_flore']); ?>
		</div>
	...
	<div class='span8 offset4' id='fieldCoord'>
		<?php print drupal_render($form['field_coordonnees_flore']); ?>
...
<div class='row-fluid' id='mesPhotos'>
	...
	<div class='row-fluid' id='foldOfPhotoSiteEditFormN9'>
		<div class='span12'>
		<p class='labelOfPicturesEditForm'>Une photo générale du paysage littoral *</p>
		<?php print drupal_render($form['field_photo_lieu_flore']); ?>
		</div>
	</div>

	<div class='row-fluid' id='foldOfPhotoEspeceEditFormN9'>
		<div class='span12'>
		<p class='labelOfPicturesEditForm'>Photos des espèces rencontrées lors de votre sortie *</p>
		<?php print drupal_render($form['field_photo_especes_flore']); ?>
		</div>
	</div>
	</div>
</div>

	<div class='row-fluid' id='foldOfNoteEditFormN9'>
		<div class='span8'>
		<?php print drupal_render($form['field_note_flore']); ?>
		</div>
...
jQuery("#clickme2add").click(function() {
	jQuery("#fieldCoord").slideDown( "slow", function() {
		jQuery('div.contentOfEditFormN9 div#foldCoord').animate({paddingBottom:'16px'});
...
jQuery("#clickme2reduce").click(function() {
	...
	jQuery("#fieldCoord").slideUp( "slow", function() {
		jQuery('div.contentOfEditFormN9 div#foldCoord').animate({paddingBottom:'0px'});
...
jQuery('h1.page-header').text("Chlorophylle-mania");
jQuery('#field-date-flore-add-more-wrapper label').text("Date d'observation*");
jQuery('.contentOfEditFormN9 button#edit-submit').text("Transmettre ma fiche d’observation");
jQuery('body.page-node-edit.node-type-programme-flore #edit-submit').text("Enregistrer les modifications");
jQuery('#edit-title').val('Chlorophylle-mania');


jQuery('.contentOfEditFormN9 button#edit-submit').click(function(event) {
	...
	jQuery('#yesBtn').click(function() {
		jQuery('form.node-form.node-programme_flore-form').submit();
	});
...
jQuery('#edit-field-localisations-flore input.geofield_wkt').each(function() {
    ...
    element.change(function(){
    	...
    	jQuery('#edit-field-coordonnees-flore input.geofield-lat').val(lon);
    	jQuery('#edit-field-coordonnees-flore input.geofield-lon').val(lat);
	})
...
jQuery('.btnMajMap').click(function() {
	...
	var lat = jQuery('#edit-field-coordonnees-flore input.geofield-lat').val();
	var lon = jQuery('#edit-field-coordonnees-flore input.geofield-lon').val();
