...
<div class="main-container container showDataOfProgN8">
  ...
  <div class="row-fluid">
      ...
      <section class="<?php print _bootstrap_content_span($columns); ?>">     
        ...
        <?php if($val == 'edit'): ?>  
          <?php if (!empty($title)): ?>
            <h1 style='border-bottom: 1px solid #eeeeee;' class="page-header"><?php print 'Modifier Fiche d’observation : Saisons de la Mer'; ?></h1>
          <?php endif; ?>
          <?php print $messages; ?>
         <!-- <?php if (!empty($tabs)): ?>
        ...
        <?php elseif($val == 'delete'): ?>
            <?php if (!empty($title)): ?>
            <h1 class="page-header"><?php print 'Supprimer Fiche d’observation : Saisons de la Mer'; ?></h1>
          <?php endif; ?>
          <?php print $messages; ?>
         <!-- <?php if (!empty($tabs)): ?>
            <?php print render($tabs); ?>
        ...
        <?php else: ?>
          ...
          <a href="<?php echo $base_url; ?>" alt=''>Accueil</a> > <a href="<?php echo $base_url; ?>/liste-actions" alt=''>Actions</a> > <a href="<?php echo $base_url; ?>/saisons-de-la-mer" alt=''>Saisons de la Mer</a> > Fiche d'observation : Saisons de la Mer
         ...
         <?php if (!empty($tabs)): ?>
          ...
          <?php if(isset($_POST['ValidThisIdent']) && $_POST['ValidThisIdent'] != ''): ?>
            <?php $query= db_update('field_data_field_com_isvalidate_saisons')
                   ->fields(array( 'field_com_isvalidate_saisons_value' => 1))
          ...
          <?php if(isset($_POST['SupprValidThisIdent']) && $_POST['SupprValidThisIdent'] != ''): ?>
            <?php $query= db_update('field_data_field_com_isvalidate_saisons')
                   ->fields(array( 'field_com_isvalidate_saisons_value' => 0))
          ...
          <?php echo views_embed_view('v_affiche_donnee_formulaire', 'block_2', $form_id); ?>   
          </div>   
          ...
          <div class="row-fluid" id='foldOfIdent'>
            ...
            <?php echo views_embed_view('v_affiche_comment', 'block_5', $form_id); ?> 
            </div>
          </div>
          ...
          <div class="row-fluid" id='foldOfCom'>
            ...
            <h3>Commentaires</h3>
            <?php echo views_embed_view('v_affiche_comment', 'block_4', $form_id); ?>   
            </div>
          </div>
     ...
     Galleria.run('#viewAfficheDataFormObs #galleria', {
      ...
      extend: function(options) {
          ...
          this.bind('image', function(e) {
              ...
              //On redefinit l'url de retour des formulaires d'indentification et de commentaires voir module nsBiolitHook
              // jQuery('#containerOfFormCom form').attr('action', base_url+'/node/'+nid+'&pic='+nameOfCurrentPic);
              ...
              jQuery('#containerOfFormIdent .field-name-field-com-nom-photo-saisons input').val(nameOfCurrentPic);
              jQuery('#containerOfFormCom .field-name-field-com-nom-photo-saisons input').val(nameOfCurrentPic);
              ...
              jQuery('div.view-v-affiche-comment.view-display-id-block_5 div.lineOfComId:not(.itsIdentifier) ').hide();
...
/*Commentaires*/
  ...
  jQuery('#containerOfFormIdent form').submit(function( event ) {
    ...
    if( jQuery('#containerOfFormIdent div.field-name-field-com-identification-saisons input').val() == '' && jQuery('#containerOfFormIdent div.field-name-field-com-nom-scientifique-saiso input').val() == '' && jQuery('#containerOfFormIdent div.field-name-field-com-lien-saisons input').val() == '' ) {
