      ...
      <div class="mask"> 
          ...
          <?php if( $nomCommum != '' || $nomSci != ''): ?>
            ...
            <?php //On affiche le nom commun nomCommum
                ...
                if($language->language == 'en') print('<h2>Brown algae and winkles<i>'.$nomCommum.'</i><i class="labelScientifique">'.$nomSci.'</i></h2>'); 
          ...
          <?php else: ?>
            ...
            <?php 
            if($language->language == 'en') print('<h2>Brown algae and winkles<i>unknown species</i></h2>');
          ...
          <?php if($language->language == 'en') : ?>
            <a href="<?php echo $base_url; ?>/node/<?php echo $nid.'&pic='.$url_pic; ?>" class="info">Get more</a> 
          <?php else: ?>
            <a href="<?php echo $base_url; ?>/node/<?php echo $nid.'&pic='.$url_pic; ?>" class="info">En savoir+</a> 
          <?php endif; ?>
      ...
      <div class="mask green"> 
          ...
          <?php if($nomCommum != ''): ?>
            ...
            <?php //On affiche le nom commun nomCommum
                $nomCommum = (strlen($nomCommum) > 13) ? substr($nomCommum,0,15).'...' : $nomCommum;
                $nomSci = (strlen($nomSci) > 13) ? substr($nomSci,0,15).'...' : $nomSci;
                if($language->language == 'en') print('<h2>Start your observations!<i>'.$nomCommum.'</i><i class="labelScientifique">'.$nomSci.'</i></h2>'); 
                else print('<h2>'.$title.'<i>'.$nomCommum.'</i><i class="labelScientifique">'.$nomSci.'</i></h2>'); 
            ?>
          ...
          <?php else: ?>
            ...
            <?php 
            if($language->language == 'en') print('<h2>Start your observations!<i>unknown species</i></h2>');
            else print('<h2>'.$title.'<i>Non-Identifiée</i></h2>');
            ?>
      ...
      <div class="mask blue"> 
          ...
          <?php if($nomCommum != ''): ?>
           ...
           <?php //On affiche le nom commun nomCommum
                $nomCommum = (strlen($nomCommum) > 13) ? substr($nomCommum,0,15).'...' : $nomCommum;
                $nomSci = (strlen($nomSci) > 13) ? substr($nomSci,0,15).'...' : $nomSci;
                if($language->language == 'en') print('<h2>Seasons of the sea<i>'.$nomCommum.'</i><i class="labelScientifique">'.$nomSci.'</i></h2>'); 
                else print('<h2>'.$title.'<i>'.$nomCommum.'</i><i class="labelScientifique">'.$nomSci.'</i></h2>'); 
            ?>
          ...
          <?php else: ?>
            ...
            <?php 
            if($language->language == 'en') print('<h2>Seasons of the sea<i>unknown species</i></h2>');
            else print('<h2>'.$title.'<i>Non-Identifiée</i></h2>');
            ?>
      ...
      <div class="mask flore"> 
          ...
          <?php if($nomCommum != ''): ?>
            ...
            <?php //On affiche le nom commun nomCommum
                $nomCommum = (strlen($nomCommum) > 13) ? substr($nomCommum,0,15).'...' : $nomCommum;
                $nomSci = (strlen($nomSci) > 13) ? substr($nomSci,0,15).'...' : $nomSci;
                if($language->language == 'en') print('<h2>Chlorophyll-mania<i>'.$nomCommum.'</i><i class="labelScientifique">'.$nomSci.'</i></h2>'); 
                else print('<h2>'.$title.'<i>'.$nomCommum.'</i><i class="labelScientifique">'.$nomSci.'</i></h2>'); 
            ?>
          ...
          <?php else: ?>
            ...
            <?php 
            if($language->language == 'en') print('<h2>Chlorophyll-mania<i>unknown species</i></h2>');
            else print('<h2>'.$title.'<i>Non-Identifiée</i></h2>');
            ?>
      ...
      <div class="mask dechet"> 
          ...
          <?php if($nomCommum != ''): ?>
           ...
           <?php //On affiche le nom commun nomCommum
                $nomCommum = (strlen($nomCommum) > 13) ? substr($nomCommum,0,15).'...' : $nomCommum;
                $nomSci = (strlen($nomSci) > 13) ? substr($nomSci,0,15).'...' : $nomSci;
                if($language->language == 'en') print('<h2>Look out, threat?<i>'.$nomCommum.'</i><i class="labelScientifique">'.$nomSci.'</i></h2>'); 
                else print('<h2>'.$title.'<i>'.$nomCommum.'</i><i class="labelScientifique">'.$nomSci.'</i></h2>'); 
            ?>
          ...
          <?php else: ?>
            ...
            <?php 
            if($language->language == 'en') print('<h2>Look out, threat?<i>unknown species</i></h2>');
            else print('<h2>'.$title.'<i>Non-Identifiée</i></h2>');
            ?>
