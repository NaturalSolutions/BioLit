 ...
 */
 global $base_path, $base_url,$user;
            ...
            // THIS IS A TEMPLATE FOR AFFICHE DATA OF FORM  : DECHET
...
<?php if ($id == 'field_localisations_dechet') : ?>
  <?php if (!empty($field->content)): ?>
...
<?php if ($id == 'field_localisations_dechet_1') : ?>
  <?php if (!empty($field->content)): ?>
...
<?php if ($id == 'field_coordonnees_dechet') : ?>
  <?php if (!empty($field->content)): ?>
...
<?php if ($id == 'field_coordonnees_dechet_1') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $coordoneeGPSuser1 = $field->content; ?>
<?php endif;?> 
<?php endif;?> 

<?php if ($id == 'field_point_de_repere_dechet') : ?>
  <?php if (!empty($field->content)): ?>
...
<?php if ($id == 'field_zone_observation_dechet') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $pointObs = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_date_observation_dechet') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $date = $field->content; ?>
  <?php endif; ?>
<?php endif;?>  

<?php if ($id == 'field_date_observation_dechet_1') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $date1 = $field->content; ?>
  <?php endif; ?>
<?php endif;?>  

<?php if ($id == 'field_note_dechet') : ?>
  <?php if (!empty($field->content)): ?>
...
<?php if ($id == 'field_heure_debut_dechet') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $hd = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_heure_fin_dechet') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $hf = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_photo_lieu_dechet') : ?>
  <?php if (!empty($field->content)): ?>
...
<div class='row-fluid' id='contentOfViewDataForm'>
  ...
  <div class='span6'>
    ...
    <div class='span12'>
    <?php foreach ($fields as $id => $field): ?>
    <?php if ($id == 'field_photo_especes_dechet') : ?>
      <?php if (!empty($field->content)): ?>
