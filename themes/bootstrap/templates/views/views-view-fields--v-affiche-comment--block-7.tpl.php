...
global $base_path, $base_url,$user;
            ...
            // THIS IS A TEMPLATE FOR AFFICHE IDENT OF OBS new
...
<?php if ($id == 'field_com_nom_photo_new') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_nom_photo = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_identification_new') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_identification = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_nom_scientifique_new') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_nom_scientifique = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_lien_new') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_lien = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_isvalidate_new') : ?>
  <?php if (!empty($field->content)): ?>
