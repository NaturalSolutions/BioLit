...
global $base_path, $base_url,$user;
            ...
            // THIS IS A TEMPLATE FOR AFFICHE IDENT OF OBS FLORE
...
<?php if ($id == 'field_com_identification_flore') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_identification = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_nom_scientifique_flore') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_nom_scientifique = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_lien_flore') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_lien = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_isvalidate_flore') : ?>
  <?php if (!empty($field->content)): ?>
