...
global $base_path, $base_url,$user;
            ...
            // THIS IS A TEMPLATE FOR AFFICHE IDENT OF OBS DECHET
...
<?php if ($id == 'field_com_nom_photo_dechet') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_nom_photo = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_identification_dechet') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_identification = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_nom_scientifique_deche') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_nom_scientifique = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_lien_dechet') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_lien = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 

<?php if ($id == 'field_com_isvalidate_dechet') : ?>
  <?php if (!empty($field->content)): ?>
