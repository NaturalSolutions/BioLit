...
global $base_path, $base_url,$user;
            ...
            // THIS IS A TEMPLATE FOR AFFICHE IDENT OF ALGUES & BIGO
...
<?php if ($id == 'field_com_algue') : ?>
  <?php if (!empty($field->content)): ?>
    <?php $field_com_algue = $field->content; ?>
  <?php endif; ?>
<?php endif;?> 
...
<?php endif;?> 
    ...
    <div class="row-fluid">
      ...
      <div class="span10">
        ...
        <?php if(isset($field_com_algue)): ?>       
            <p class='ident_nom_algue'>Nom de l'algue : <i><?php echo $field_com_algue; ?></i></p>
        <?php endif; ?>
    ...
    <?php endif; ?> <!-- fin si c'est moderateur biolit connecté -->
