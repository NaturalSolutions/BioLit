...
<div class="main-container container showDataOfProgN1">
  ...
  <div class="row-fluid">
      ...
      <section class="<?php print _bootstrap_content_span($columns); ?>">     
        ...
        <?php if($val == 'edit'): ?>  
          <?php if (!empty($title)): ?>
            <h1 style='border-bottom: 1px solid #eeeeee;' class="page-header"><?php print 'Modifier Fiche d’observation : Algues & Bigorneaux'; ?></h1>
          <?php endif; ?>
          <?php print $messages; ?>
         <!-- <?php if (!empty($tabs)): ?>
        ...
        <?php elseif($val == 'delete'): ?>
            <?php if (!empty($title)): ?>
            <h1 class="page-header"><?php print 'Supprimer Fiche d’observation : Algues & Bigorneaux'; ?></h1>
          <?php endif; ?>
          <?php print $messages; ?>
         <!-- <?php if (!empty($tabs)): ?>
            <?php print render($tabs); ?>
        ...
        <?php else: ?>
          ...
          <a href="<?php echo $base_url; ?>" alt=''>Accueil</a> > <a href="<?php echo $base_url; ?>/liste-actions" alt=''>Actions</a> > <a href="<?php echo $base_url; ?>/algues-brunes-et-bigorneaux" alt=''>Algues brunes et bigorneaux</a> > Fiche d'observation
         ...
         <?php if (!empty($tabs)): ?>
          ...
          <?php if(isset($_POST['ValidThisIdent']) && $_POST['ValidThisIdent'] != ''): ?>
            <?php $query= db_update('field_data_field_com_isvalidate')
                   ->fields(array( 'field_com_isvalidate_value' => 1))
          ...
          <?php if(isset($_POST['SupprValidThisIdent']) && $_POST['SupprValidThisIdent'] != ''): ?>
            <?php $query= db_update('field_data_field_com_isvalidate')
                   ->fields(array( 'field_com_isvalidate_value' => 0))
          ...
          <?php echo views_embed_view('v_affiche_donnee_formulaire', 'block', $form_id); ?>   
          </div> 

          
          <div class="row-fluid" id='foldOfIdent'>
            <div class="span12">
              <h3>Proposition d'indentification</h3>   
               <!-- Affichage des Identifictions -->
            <?php echo views_embed_view('v_affiche_comment', 'block_1', $form_id); ?> 
            </div>
          </div>
          ...
          <div class="row-fluid" id='foldOfCom'>
            ...
            <h3>Commentaires</h3>
            <?php echo views_embed_view('v_affiche_comment', 'block', $form_id); ?>   
            </div>
          </div>
   ...
   Galleria.run('#viewAfficheDataFormObs #galleria', {
    ...
    extend: function(options) {
        ...
        this.bind('image', function(e) {
            ...
            jQuery('#containerOfFormIdent .field-name-field-com-nom-photo input').val(nameOfCurrentPic);
            jQuery('#containerOfFormCom .field-name-field-com-nom-photo input').val(nameOfCurrentPic);
            ...
            jQuery('div.view-v-affiche-comment.view-display-id-block_1 div.lineOfComId:not(.itsIdentifier) ').hide();
...
//Animation Show / Hide du formulaire d'identification
...
jQuery('#containerOfFormIdent form').submit(function( event ) {
  ...
  if( jQuery('#containerOfFormIdent div.field-name-field-com-identification input').val() == '' && jQuery('#containerOfFormIdent div.field-name-field-com-nom-scientifique input').val() == '' && jQuery('#containerOfFormIdent div.field-name-field-com-lien input').val() == '' && jQuery('#containerOfFormIdent .field-name-field-com-algue option:selected').val() == '_none') {
    
    //Annulation de comportement de base du bouton submit
    event.preventDefault();
    alert("Veuillez saisir un minimum d'informations");
