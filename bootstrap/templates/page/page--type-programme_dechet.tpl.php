...
<div class="main-container container showDataOfProgN11">
  ...
  <div class="row-fluid">
      ...
      <section class="<?php print _bootstrap_content_span($columns); ?>">     
        ...
        <?php if($val == 'edit'): ?>  
          <?php if (!empty($title)): ?>
            <h1 style='border-bottom: 1px solid #eeeeee;' class="page-header"><?php print 'Modifier Fiche d’observation : Attention, menace ? '; ?></h1>
          <?php endif; ?>
          <?php print $messages; ?>
         <!-- <?php if (!empty($tabs)): ?>
        ...
        <?php elseif($val == 'delete'): ?>
            <?php if (!empty($title)): ?>
            <h1 class="page-header"><?php print 'Supprimer Fiche d’observation : Attention, menace ? '; ?></h1>
          <?php endif; ?>
          <?php print $messages; ?>
         <!-- <?php if (!empty($tabs)): ?>
            <?php print render($tabs); ?>
        ...
        <?php else: ?>
          ...
          <a href="<?php echo $base_url; ?>" alt=''>Accueil</a> > <a href="<?php echo $base_url; ?>/liste-actions" alt=''>Actions</a> > <a href="<?php echo $base_url; ?>/attention-menace" alt=''>Attention, menace ? </a> > Fiche d'observation : Attention, menace ? 
         ...
         <?php if (!empty($tabs)): ?>
          ...
          <?php if(isset($_POST['ValidThisIdent']) && $_POST['ValidThisIdent'] != ''): ?>
            <?php $query= db_update('field_data_field_com_isvalidate_dechet')
                   ->fields(array( 'field_com_isvalidate_dechet_value' => 1))
           ...
           <?php endif; ?>
            ...
            <?php $query= db_update('field_data_field_com_isvalidate_dechet')
                   ->fields(array( 'field_com_isvalidate_dechet_value' => 0))
          ...
          <?php echo views_embed_view('v_affiche_donnee_formulaire', 'block_5', $form_id); ?>   
          </div>   
         ...
         <!--  <div class="row-fluid" id='foldOfIdent'>
            ...
            <?php //echo views_embed_view('v_affiche_comment', 'block_11', $form_id); ?> 
            </div>
          </div> -->
...
<!--           <?php //if ( $user->uid ): ?>
          ...
          <div class="row-fluid" id='foldOfCom'>
            ...
            <h3>Commentaires</h3>
            <?php echo views_embed_view('v_affiche_comment', 'block_10', $form_id); ?>   
            </div>
          </div>
   ...
   Galleria.run('#viewAfficheDataFormObs #galleria', {
    ...
    extend: function(options) {
        ...
        this.bind('image', function(e) {
          ...
          jQuery('#containerOfFormIdent .field-name-field-com-nom-photo-dechet input').val(nameOfCurrentPic);
          jQuery('#containerOfFormCom .field-name-field-com-nom-photo-dechet input').val(nameOfCurrentPic);
          ...
          jQuery('div.view-v-affiche-comment.view-display-id-block_11 div.lineOfComId:not(.itsIdentifier) ').hide();
...
jQuery('#containerOfFormIdent form').submit(function( event ) {
  ...
  if( jQuery('#containerOfFormIdent div.field-name-field-com-identification-dechet input').val() == '' && jQuery('#containerOfFormIdent div.field-name-field-com-nom-scientifique-deche input').val() == '' && jQuery('#containerOfFormIdent div.field-name-field-com-lien-dechet input').val() == '' ) {
